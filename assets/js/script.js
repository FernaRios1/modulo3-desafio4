const propiedades_venta = [
    ...
    },
    {
      ...
      {
        nombre: "Probando que pasa si pongo 4",
        src: "https://www.portalpm.cl/wp-content/uploads/2024/03/VVII-PISCINA-1920x1080-1.jpeg",
        descripcion: "Este penthouse de lujo ofrece una terraza panorámica con vistas espectaculare",
        ubicacion: "567 Skyline Avenue, Skyview City, CA 56789",
        habitaciones: 3,
        banios:4,
...
function renderizarPropiedades(arreglo, contenedor) {
  ...
  renderizarPropiedades(propiedades_arriendo.slice(0, 3), "contenedor-arriendo");